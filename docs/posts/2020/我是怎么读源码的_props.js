...
export default {
    ...
    'outputPath': "posts/2020/我是怎么读源码的.html",
    'title': "我是如何阅读源码的",
    'content': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<h1>我是如何阅读源码的</h1>\n<p>最近写了很多源码分析相关的文章，React、Vue 都有，想把我阅读源码的一些心得分享给大家。</p>\n<p><strong>React：</strong></p>\n<ul>\n<li><a href="https://blog.shenfq.com/posts/2020/React%20%E6%9E%B6%E6%9E%84%E7%9A%84%E6%BC%94%E5%8F%98%20-%20%E4%BB%8E%E5%90%8C%E6%AD%A5%E5%88%B0%E5%BC%82%E6%AD%A5.html">React 架构的演变 - 从同步到异步</a></li>\n<li><a href="https://blog.shenfq.com/posts/2020/React%20%E6%9E%B6%E6%9E%84%E7%9A%84%E6%BC%94%E5%8F%98%20-%20%E4%BB%8E%E9%80%92%E5%BD%92%E5%88%B0%E5%BE%AA%E7%8E%AF.html">React 架构的演变 - 从递归到循环</a></li>\n<li><a href="https://blog.shenfq.com/posts/2020/React%20%E6%9E%B6%E6%9E%84%E7%9A%84%E6%BC%94%E5%8F%98%20-%20%E6%9B%B4%E6%96%B0%E6%9C%BA%E5%88%B6.html">React 架构的演变 - 更新机制</a></li>\n<li><a href="https://blog.shenfq.com/posts/2020/React%20%E6%9E%B6%E6%9E%84%E7%9A%84%E6%BC%94%E5%8F%98%20-%20Hooks%20%E7%9A%84%E5%AE%9E%E7%8E%B0.html">React 架构的演变 - Hooks 的实现</a></li>\n</ul>\n<p><strong>Vue：</strong></p>\n<ul>\n<li><a href="https://blog.shenfq.com/posts/2020/Vue%E6%A8%A1%E6%9D%BF%E7%BC%96%E8%AF%91%E5%8E%9F%E7%90%86.html">Vue 模板编译原理</a></li>\n<li><a href="https://blog.shenfq.com/posts/2020/Vue3%20%E6%A8%A1%E6%9D%BF%E7%BC%96%E8%AF%91%E4%BC%98%E5%8C%96.html">Vue3 模板编译优化</a></li>\n<li><a href="https://blog.shenfq.com/posts/2020/Vue3%20Teleport%20%E7%BB%84%E4%BB%B6%E7%9A%84%E5%AE%9E%E8%B7%B5%E5%8F%8A%E5%8E%9F%E7%90%86.html">Vue3 Teleport 组件的实践及原理</a></li>\n</ul>\n<h2 id="%E5%BF%AB%E9%80%9F%E8%B0%83%E8%AF%95%E6%BA%90%E7%A0%81">快速调试源码<a class="anchor" href="#%E5%BF%AB%E9%80%9F%E8%B0%83%E8%AF%95%E6%BA%90%E7%A0%81">§</a></h2>\n<p>说到看源码，很多人都有个误区，觉得看源码必须要到 github 上把完整的代码 clone 下来，认为只有把完整的代码下载下来，才能开始愉快的学习。</p>\n<h3 id="%E8%B0%83%E8%AF%95-react">调试 React<a class="anchor" href="#%E8%B0%83%E8%AF%95-react">§</a></h3>\n<p>这里我们先拿 React 举例，把源码 clone 下之后，整个人都懵逼了。</p>\n<pre class="language-bash"><code class="language-bash"><span class="token function">git</span> clone <a class="token email-link" href="mailto:git@github.com">git@github.com</a>:facebook/react.git\n</code></pre>\n<p><img src="https://file.shenfq.com/pic/20201205210806.png" alt="React 源码目录解构"></p>\n<p>一般这时候会开始在网上搜文章，如何调试 React 源码。但是这种大型项目的构建流程较为复杂，如果只是想简单了解源码，不需要去了解这些复杂的东西。这里教大家一个简单的方案，直接到 <a href="https://www.jsdelivr.com/">CDN</a> 上下载官方编译好了的开发版源码（<a href="https://cdn.jsdelivr.net/npm/react@17.0.1/umd/react.development.js">https://cdn.jsdelivr.net/npm/react@17.0.1/umd/react.development.js</a>），中间的版本号可以替换成任何想看的版本。</p>\n<p><img src="https://file.shenfq.com/pic/20201205214642.png" alt="react"></p>\n<p>有了源码之后，我们要开始写 Demo，这时候如果自己搭一个项目就比较麻烦了，因为写 React 就会有 jsx，就需要 babel 进行 jsx 转义，这里推荐使用官方脚手架：<a href="https://github.com/facebook/create-react-app"> <code>create-react-app</code></a>。</p>\n<pre class="language-bash"><code class="language-bash">npx create-react-app react-demo\n<span class="token builtin class-name">cd</span> react-demo\n</code></pre>\n<p>这里我们需要稍微修改下 webpack 的配置，通过 <code>react-app-rewired</code> 修改配置。</p>\n<pre class="language-bash"><code class="language-bash"><span class="token function">npm</span> <span class="token function">install</span> react-app-rewired --save-dev\n</code></pre>\n<p><img src="https://file.shenfq.com/pic/20201205224815.png" alt="修改package.json"></p>\n<p>然后，在文件夹内新建 <code>config-overrides.js</code> 文件，配置 webpack 的 <code>externals</code> 属性，让项目内的 react、react-dom 都能够走 window 下挂载的对象。</p>\n<pre class="language-js"><code class="language-js"><span class="token comment">/* config-overrides.js */</span>\n\nmodule<span class="token punctuation">.</span><span class="token method-variable function-variable method function property-access">exports</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token function">override</span><span class="token punctuation">(</span><span class="token parameter">config<span class="token punctuation">,</span> env</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n  <span class="token comment">// do stuff with the webpack config...</span>\n  config<span class="token punctuation">.</span><span class="token property-access">externals</span> <span class="token operator">=</span> <span class="token punctuation">{</span>\n    <span class="token string">\'react\'</span><span class="token operator">:</span> <span class="token string">\'window.React\'</span><span class="token punctuation">,</span>\n    <span class="token string">\'react-dom\'</span><span class="token operator">:</span> <span class="token string">\'window.ReactDOM\'</span><span class="token punctuation">,</span>\n  <span class="token punctuation">}</span><span class="token punctuation">;</span>\n  <span class="token keyword control-flow">return</span> config<span class="token punctuation">;</span>\n<span class="token punctuation">}</span>\n</code></pre>\n<p>接下就是将 react 挂载到 window 上，把我们之前在 CDN 上下载的 develope 版的源码放到 <code>public</code> 目录，然后在 <code>public/index.html</code> 中引入源码。</p>\n<p><img src="https://file.shenfq.com/pic/20201205225910.png" alt="全局引入 react"></p>\n<p>然后通过 <code>npm run start</code> 正常启动项目就好了。</p>\n<p><img src="https://file.shenfq.com/pic/20201205230552.png" alt="React App"></p>\n<p>接下来就能愉快的搞事情，可以在 Chrome 的 Sources 面板里面开始 debug 之旅了，当然如果你更喜欢 <code>console.log</code> ，也可以在 <code>public/react.js</code> 里打上心爱的 log 。</p>\n<p><img src="https://file.shenfq.com/pic/20201205231401.png" alt="Sources"></p>\n<h3 id="%E8%B0%83%E8%AF%95-vue">调试 Vue<a class="anchor" href="#%E8%B0%83%E8%AF%95-vue">§</a></h3>\n<p>调试 Vue 比 React 更加简单，因为 Vue 支持浏览器进行模板编译。我们同样在 <a href="https://www.jsdelivr.com/">CDN</a> 直接下载已经编译好的完整开发版（<a href="https://www.jsdelivr.com/package/npm/vue?version=3.0.4&amp;path=dist">https://www.jsdelivr.com/package/npm/vue?version=3.0.4&amp;path=dist</a>）。</p>\n<p><img src="https://file.shenfq.com/pic/20201205232605.png" alt="image-20201205232605725"></p>\n<p>然后，新建一个 <code>vue.html</code> ，把文件丢到本地的 http 服务里面。</p>\n<pre class="language-html"><code class="language-html"><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>en<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>head</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>meta</span> <span class="token attr-name">charset</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>UTF-8<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>title</span><span class="token punctuation">></span></span>Vue3 Demo<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>title</span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>head</span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>app<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/script/vue3.js<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token script"></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>script</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">\n    <span class="token keyword">const</span> app <span class="token operator">=</span> <span class="token maybe-class-name">Vue</span><span class="token punctuation">.</span><span class="token method function property-access">createApp</span><span class="token punctuation">(</span><span class="token punctuation">{</span>\n      <span class="token function">data</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n        <span class="token keyword control-flow">return</span> <span class="token punctuation">{</span>\n          name<span class="token operator">:</span> <span class="token string">\'shenfq\'</span>\n        <span class="token punctuation">}</span>\n      <span class="token punctuation">}</span><span class="token punctuation">,</span>\n      template<span class="token operator">:</span> <span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string">&lt;div> Vue App &lt;/div> </span><span class="token template-punctuation string">`</span></span>\n    <span class="token punctuation">}</span><span class="token punctuation">)</span>\n    app<span class="token punctuation">.</span><span class="token method function property-access">mount</span><span class="token punctuation">(</span><span class="token string">\'#app\'</span><span class="token punctuation">)</span>\n  </span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>script</span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">></span></span>\n</code></pre>\n<p>我们现在已经可以直接开始调试 Vue3 的源码了，就是这么简单粗暴。当然，如果想通过 <code>.vue</code> 的方式写模板，还是得参照上面 React 提到的那种方式。</p>\n<h2 id="%E6%89%BE%E5%87%86%E5%88%87%E5%85%A5%E7%82%B9">找准切入点<a class="anchor" href="#%E6%89%BE%E5%87%86%E5%88%87%E5%85%A5%E7%82%B9">§</a></h2>\n<p>有了调试源码的方法，我们还需要找准一个切入点，不能为了看源码而看源码。所谓的切入点就是一个个小问题，比如我想要弄懂 Vue 的模板是如何转变成虚拟 DOM 的，我们可以先在官方文档查找资料，看有没有相关说明，幸运的是，Vue 官方文档在<a href="https://vue3js.cn/docs/zh/guide/render-function.html#%E6%A8%A1%E6%9D%BF%E7%BC%96%E8%AF%91"><code>渲染函数-模板编译</code></a>部分刚好这个问题有相关说明。</p>\n<p><img src="https://file.shenfq.com/pic/20201206135457.png" alt="Vue官方文档"></p>\n<p>文档中提到了 <code>Vue.compile</code> ，然后我们就可以在源码中搜索这个 Api 开始进行调试。这就是带着目的去看源码，我们只有带着问题出发的时候，才会具有更高的效率。</p>\n<p>除了带着问题出发，还可以参考其他优秀的文章，集千万网友的智慧于一体。当然这也是个双刃剑，因为你可能会搜到一些辣鸡文章，反而降低你的效率。而且，框架在迭代的过程中，变化会很多，可能你学习的是 React 16 的源码，搜到的 React 15 相关的文章，然后你会花很多时间和精力想去弄清楚为什么你看到的和别人写的为什么不一样，到底是你的打开方式不对，还是作者有笔误。</p>\n<p>同时，还有一些文章喜欢画一些吸引眼球的架构图（<em>我本人</em>），看完你会直呼内行，但是这些架构图大多是站在作者个人的角度上的画的，很可能和你之前的角度不一样，又需要花一些时间来理解他的思路。如果，我们把庞大的项目拆分成一个个小小的问题之后，逐个击破，这时候再从全局的角度来思考整个框架的设计思路以及运行逻辑，就能事半功倍。</p>\n<h2 id="%E5%BC%BA%E5%88%B6%E8%BE%93%E5%87%BA">强制输出<a class="anchor" href="#%E5%BC%BA%E5%88%B6%E8%BE%93%E5%87%BA">§</a></h2>\n<p>有输出的学习才是学习，在阅读源码的过程中，一定得边看边思考，思考的过程中，还需要形成文字记录，如果只是一直盯着代码看，很难理解。</p>\n<p>我在看源码的过程中，会一直思考，怎么样才能将这部分讲给别人听，是不是能写个 Demo 之类的，让大家跟着我的思路来学习。这样即让自己学懂了，又可以将学习的过程分享出来帮助到其他人，何乐而不为。</p>'
        } }),
    ...
    'contentTitle': React.createElement("h1", { key: "0" }, "\u6211\u662F\u5982\u4F55\u9605\u8BFB\u6E90\u7801\u7684"),
    'contentBody': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<p>最近写了很多源码分析相关的文章，React、Vue 都有，想把我阅读源码的一些心得分享给大家。</p>\n<p><strong>React：</strong></p>\n<ul>\n<li><a href="https://blog.shenfq.com/posts/2020/React%20%E6%9E%B6%E6%9E%84%E7%9A%84%E6%BC%94%E5%8F%98%20-%20%E4%BB%8E%E5%90%8C%E6%AD%A5%E5%88%B0%E5%BC%82%E6%AD%A5.html">React 架构的演变 - 从同步到异步</a></li>\n<li><a href="https://blog.shenfq.com/posts/2020/React%20%E6%9E%B6%E6%9E%84%E7%9A%84%E6%BC%94%E5%8F%98%20-%20%E4%BB%8E%E9%80%92%E5%BD%92%E5%88%B0%E5%BE%AA%E7%8E%AF.html">React 架构的演变 - 从递归到循环</a></li>\n<li><a href="https://blog.shenfq.com/posts/2020/React%20%E6%9E%B6%E6%9E%84%E7%9A%84%E6%BC%94%E5%8F%98%20-%20%E6%9B%B4%E6%96%B0%E6%9C%BA%E5%88%B6.html">React 架构的演变 - 更新机制</a></li>\n<li><a href="https://blog.shenfq.com/posts/2020/React%20%E6%9E%B6%E6%9E%84%E7%9A%84%E6%BC%94%E5%8F%98%20-%20Hooks%20%E7%9A%84%E5%AE%9E%E7%8E%B0.html">React 架构的演变 - Hooks 的实现</a></li>\n</ul>\n<p><strong>Vue：</strong></p>\n<ul>\n<li><a href="https://blog.shenfq.com/posts/2020/Vue%E6%A8%A1%E6%9D%BF%E7%BC%96%E8%AF%91%E5%8E%9F%E7%90%86.html">Vue 模板编译原理</a></li>\n<li><a href="https://blog.shenfq.com/posts/2020/Vue3%20%E6%A8%A1%E6%9D%BF%E7%BC%96%E8%AF%91%E4%BC%98%E5%8C%96.html">Vue3 模板编译优化</a></li>\n<li><a href="https://blog.shenfq.com/posts/2020/Vue3%20Teleport%20%E7%BB%84%E4%BB%B6%E7%9A%84%E5%AE%9E%E8%B7%B5%E5%8F%8A%E5%8E%9F%E7%90%86.html">Vue3 Teleport 组件的实践及原理</a></li>\n</ul>\n<h2 id="%E5%BF%AB%E9%80%9F%E8%B0%83%E8%AF%95%E6%BA%90%E7%A0%81">快速调试源码<a class="anchor" href="#%E5%BF%AB%E9%80%9F%E8%B0%83%E8%AF%95%E6%BA%90%E7%A0%81">§</a></h2>\n<p>说到看源码，很多人都有个误区，觉得看源码必须要到 github 上把完整的代码 clone 下来，认为只有把完整的代码下载下来，才能开始愉快的学习。</p>\n<h3 id="%E8%B0%83%E8%AF%95-react">调试 React<a class="anchor" href="#%E8%B0%83%E8%AF%95-react">§</a></h3>\n<p>这里我们先拿 React 举例，把源码 clone 下之后，整个人都懵逼了。</p>\n<pre class="language-bash"><code class="language-bash"><span class="token function">git</span> clone <a class="token email-link" href="mailto:git@github.com">git@github.com</a>:facebook/react.git\n</code></pre>\n<p><img src="https://file.shenfq.com/pic/20201205210806.png" alt="React 源码目录解构"></p>\n<p>一般这时候会开始在网上搜文章，如何调试 React 源码。但是这种大型项目的构建流程较为复杂，如果只是想简单了解源码，不需要去了解这些复杂的东西。这里教大家一个简单的方案，直接到 <a href="https://www.jsdelivr.com/">CDN</a> 上下载官方编译好了的开发版源码（<a href="https://cdn.jsdelivr.net/npm/react@17.0.1/umd/react.development.js">https://cdn.jsdelivr.net/npm/react@17.0.1/umd/react.development.js</a>），中间的版本号可以替换成任何想看的版本。</p>\n<p><img src="https://file.shenfq.com/pic/20201205214642.png" alt="react"></p>\n<p>有了源码之后，我们要开始写 Demo，这时候如果自己搭一个项目就比较麻烦了，因为写 React 就会有 jsx，就需要 babel 进行 jsx 转义，这里推荐使用官方脚手架：<a href="https://github.com/facebook/create-react-app"> <code>create-react-app</code></a>。</p>\n<pre class="language-bash"><code class="language-bash">npx create-react-app react-demo\n<span class="token builtin class-name">cd</span> react-demo\n</code></pre>\n<p>这里我们需要稍微修改下 webpack 的配置，通过 <code>react-app-rewired</code> 修改配置。</p>\n<pre class="language-bash"><code class="language-bash"><span class="token function">npm</span> <span class="token function">install</span> react-app-rewired --save-dev\n</code></pre>\n<p><img src="https://file.shenfq.com/pic/20201205224815.png" alt="修改package.json"></p>\n<p>然后，在文件夹内新建 <code>config-overrides.js</code> 文件，配置 webpack 的 <code>externals</code> 属性，让项目内的 react、react-dom 都能够走 window 下挂载的对象。</p>\n<pre class="language-js"><code class="language-js"><span class="token comment">/* config-overrides.js */</span>\n\nmodule<span class="token punctuation">.</span><span class="token method-variable function-variable method function property-access">exports</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token function">override</span><span class="token punctuation">(</span><span class="token parameter">config<span class="token punctuation">,</span> env</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n  <span class="token comment">// do stuff with the webpack config...</span>\n  config<span class="token punctuation">.</span><span class="token property-access">externals</span> <span class="token operator">=</span> <span class="token punctuation">{</span>\n    <span class="token string">\'react\'</span><span class="token operator">:</span> <span class="token string">\'window.React\'</span><span class="token punctuation">,</span>\n    <span class="token string">\'react-dom\'</span><span class="token operator">:</span> <span class="token string">\'window.ReactDOM\'</span><span class="token punctuation">,</span>\n  <span class="token punctuation">}</span><span class="token punctuation">;</span>\n  <span class="token keyword control-flow">return</span> config<span class="token punctuation">;</span>\n<span class="token punctuation">}</span>\n</code></pre>\n<p>接下就是将 react 挂载到 window 上，把我们之前在 CDN 上下载的 develope 版的源码放到 <code>public</code> 目录，然后在 <code>public/index.html</code> 中引入源码。</p>\n<p><img src="https://file.shenfq.com/pic/20201205225910.png" alt="全局引入 react"></p>\n<p>然后通过 <code>npm run start</code> 正常启动项目就好了。</p>\n<p><img src="https://file.shenfq.com/pic/20201205230552.png" alt="React App"></p>\n<p>接下来就能愉快的搞事情，可以在 Chrome 的 Sources 面板里面开始 debug 之旅了，当然如果你更喜欢 <code>console.log</code> ，也可以在 <code>public/react.js</code> 里打上心爱的 log 。</p>\n<p><img src="https://file.shenfq.com/pic/20201205231401.png" alt="Sources"></p>\n<h3 id="%E8%B0%83%E8%AF%95-vue">调试 Vue<a class="anchor" href="#%E8%B0%83%E8%AF%95-vue">§</a></h3>\n<p>调试 Vue 比 React 更加简单，因为 Vue 支持浏览器进行模板编译。我们同样在 <a href="https://www.jsdelivr.com/">CDN</a> 直接下载已经编译好的完整开发版（<a href="https://www.jsdelivr.com/package/npm/vue?version=3.0.4&amp;path=dist">https://www.jsdelivr.com/package/npm/vue?version=3.0.4&amp;path=dist</a>）。</p>\n<p><img src="https://file.shenfq.com/pic/20201205232605.png" alt="image-20201205232605725"></p>\n<p>然后，新建一个 <code>vue.html</code> ，把文件丢到本地的 http 服务里面。</p>\n<pre class="language-html"><code class="language-html"><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>en<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>head</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>meta</span> <span class="token attr-name">charset</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>UTF-8<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>title</span><span class="token punctuation">></span></span>Vue3 Demo<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>title</span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>head</span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>app<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/script/vue3.js<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token script"></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>script</span><span class="token punctuation">></span></span>\n  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">\n    <span class="token keyword">const</span> app <span class="token operator">=</span> <span class="token maybe-class-name">Vue</span><span class="token punctuation">.</span><span class="token method function property-access">createApp</span><span class="token punctuation">(</span><span class="token punctuation">{</span>\n      <span class="token function">data</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n        <span class="token keyword control-flow">return</span> <span class="token punctuation">{</span>\n          name<span class="token operator">:</span> <span class="token string">\'shenfq\'</span>\n        <span class="token punctuation">}</span>\n      <span class="token punctuation">}</span><span class="token punctuation">,</span>\n      template<span class="token operator">:</span> <span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string">&lt;div> Vue App &lt;/div> </span><span class="token template-punctuation string">`</span></span>\n    <span class="token punctuation">}</span><span class="token punctuation">)</span>\n    app<span class="token punctuation">.</span><span class="token method function property-access">mount</span><span class="token punctuation">(</span><span class="token string">\'#app\'</span><span class="token punctuation">)</span>\n  </span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>script</span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">></span></span>\n<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">></span></span>\n</code></pre>\n<p>我们现在已经可以直接开始调试 Vue3 的源码了，就是这么简单粗暴。当然，如果想通过 <code>.vue</code> 的方式写模板，还是得参照上面 React 提到的那种方式。</p>\n<h2 id="%E6%89%BE%E5%87%86%E5%88%87%E5%85%A5%E7%82%B9">找准切入点<a class="anchor" href="#%E6%89%BE%E5%87%86%E5%88%87%E5%85%A5%E7%82%B9">§</a></h2>\n<p>有了调试源码的方法，我们还需要找准一个切入点，不能为了看源码而看源码。所谓的切入点就是一个个小问题，比如我想要弄懂 Vue 的模板是如何转变成虚拟 DOM 的，我们可以先在官方文档查找资料，看有没有相关说明，幸运的是，Vue 官方文档在<a href="https://vue3js.cn/docs/zh/guide/render-function.html#%E6%A8%A1%E6%9D%BF%E7%BC%96%E8%AF%91"><code>渲染函数-模板编译</code></a>部分刚好这个问题有相关说明。</p>\n<p><img src="https://file.shenfq.com/pic/20201206135457.png" alt="Vue官方文档"></p>\n<p>文档中提到了 <code>Vue.compile</code> ，然后我们就可以在源码中搜索这个 Api 开始进行调试。这就是带着目的去看源码，我们只有带着问题出发的时候，才会具有更高的效率。</p>\n<p>除了带着问题出发，还可以参考其他优秀的文章，集千万网友的智慧于一体。当然这也是个双刃剑，因为你可能会搜到一些辣鸡文章，反而降低你的效率。而且，框架在迭代的过程中，变化会很多，可能你学习的是 React 16 的源码，搜到的 React 15 相关的文章，然后你会花很多时间和精力想去弄清楚为什么你看到的和别人写的为什么不一样，到底是你的打开方式不对，还是作者有笔误。</p>\n<p>同时，还有一些文章喜欢画一些吸引眼球的架构图（<em>我本人</em>），看完你会直呼内行，但是这些架构图大多是站在作者个人的角度上的画的，很可能和你之前的角度不一样，又需要花一些时间来理解他的思路。如果，我们把庞大的项目拆分成一个个小小的问题之后，逐个击破，这时候再从全局的角度来思考整个框架的设计思路以及运行逻辑，就能事半功倍。</p>\n<h2 id="%E5%BC%BA%E5%88%B6%E8%BE%93%E5%87%BA">强制输出<a class="anchor" href="#%E5%BC%BA%E5%88%B6%E8%BE%93%E5%87%BA">§</a></h2>\n<p>有输出的学习才是学习，在阅读源码的过程中，一定得边看边思考，思考的过程中，还需要形成文字记录，如果只是一直盯着代码看，很难理解。</p>\n<p>我在看源码的过程中，会一直思考，怎么样才能将这部分讲给别人听，是不是能写个 Demo 之类的，让大家跟着我的思路来学习。这样即让自己学懂了，又可以将学习的过程分享出来帮助到其他人，何乐而不为。</p>'
        } }),
    'toc': React.createElement("nav", { key: "0", className: "toc" },
        React.createElement("ol", null,
            React.createElement("li", null,
                React.createElement("a", { href: "#%E5%BF%AB%E9%80%9F%E8%B0%83%E8%AF%95%E6%BA%90%E7%A0%81" }, "\u5FEB\u901F\u8C03\u8BD5\u6E90\u7801"),
                React.createElement("ol", null,
                    React.createElement("li", null,
                        React.createElement("a", { href: "#%E8%B0%83%E8%AF%95-react" }, "\u8C03\u8BD5 React")),
                    React.createElement("li", null,
                        React.createElement("a", { href: "#%E8%B0%83%E8%AF%95-vue" }, "\u8C03\u8BD5 Vue")))),
            React.createElement("li", null,
                React.createElement("a", { href: "#%E6%89%BE%E5%87%86%E5%88%87%E5%85%A5%E7%82%B9" }, "\u627E\u51C6\u5207\u5165\u70B9")),
            React.createElement("li", null,
                React.createElement("a", { href: "#%E5%BC%BA%E5%88%B6%E8%BE%93%E5%87%BA" }, "\u5F3A\u5236\u8F93\u51FA")))),
    'author': "shenfq",
    'contributors': [
        "shenfq",
        "Shenfq"
